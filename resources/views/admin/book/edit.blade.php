...
@section('content')
	<div class="admin-edit">
		<h3 class="edit-title-book">Biblioteca - Editar Livro <a class="btn btn-primary float-right" href="javascript:history.go(-1)">Voltar</a></h3>
		<form class="form" action="{{route('admin.books.update', ['book' => $book->id])}}" method="post" enctype="multipart/form-data">
			...
			<div class="form-row"><!-- Inicio linha 4 -->
				...
				<div class="col-md-6 form-group mt-4">
					<button class="btn btn-success btn-block mt-2 submit-book" type="submit">Atualizar Livro</button>
				</div>
			</div><!-- Fim Linha 4 -->
		</form>	
	</div>
